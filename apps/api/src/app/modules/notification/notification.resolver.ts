...
import { NotificationCountQueryArgs, NotificationQueryArgs } from './dto/notification-query-arg';
import { UseGuards } from '@nestjs/common';
import { AuthenticatedGuard } from '../auth/guards/authenticated.guard';
import { NotificationUpdateArgs } from './dto/notification-update';
import { NotificationCount, NotificationResponse } from './dto/updateRespnse.dto';
...
export class NotificationResolver {
  ...
  @UseGuards(AuthenticatedGuard)
  @Mutation(()=>NotificationResponse)
  async markNotification(@Args('markNotificationArgs') markNotificationArgs:NotificationCountQueryArgs){
      return await this.notificationService.notificationMark(markNotificationArgs)
