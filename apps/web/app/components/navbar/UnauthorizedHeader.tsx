...
import { Button, GradientBar, Heading } from '~ui';
import SwitchTheme from './SwitchTheme';

export function UnauthorizedHeader() {
  return (
    <div className="relative">
      <header className="fixed inset-0 z-40 overflow-y-auto bg-white dark:bg-gray-900 shadow-sm lg:static lg:overflow-y-visible">
        <GradientBar
          color="pink"
          size="md"
