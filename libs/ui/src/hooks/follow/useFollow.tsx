...
const {mutateAsync:FollowUserMutate,isLoading:FollowLoading} = useFollowUserMutation();
const {mutateAsync:UnFollowUserMutate,isLoading:UnFollowLoading} = useUnFollowUserMutation({
...
const queryClient = useQueryClient();
  ...
  const attemptToFollow = async (FollowId:string) => {
   try {
    toast.promise(FollowUserMutate({followOrUnFollowInput:{follow_ID:FollowId} }), {
      loading: 'Logging in...',
  ...
  const attemptToUnFollow = async (FollowId:string) => {
    try {
      toast.promise(UnFollowUserMutate({followOrUnFollowInput:{follow_ID:FollowId} }), {
        loading: 'Logging in...',
