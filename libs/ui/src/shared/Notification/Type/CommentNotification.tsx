...
const CommentNotification: FC<CommentNotificationProps> = ({
  ...
  return (
    <div
      className={cn(
        'flex items-start justify-between border cursor-pointer border-transparent dark:hover:border-indigo-700 p-4 hover:bg-gray-100 dark:hover:bg-indigo-1100 hover:opacity-95 divide-y divide-gray-100',
        notification.unread
